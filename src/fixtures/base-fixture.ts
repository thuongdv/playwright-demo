...
import HotelSignupPage from "pages/hotel/signup.page";
...
export const test = baseTest.extend<Pages>({
  ...
  hotelSignupPage: async ({ page }, use) => {
    const hotelSignupPage = new HotelSignupPage(page);
    await use(hotelSignupPage);
  },
